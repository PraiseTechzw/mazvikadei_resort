-- =====================================================
-- MAZVIKADEI RESORT DATABASE MIGRATION SCRIPT
-- =====================================================
-- This script updates the existing database to include all enhancements
-- Run this if you already have the basic database setup
...
ALTER TABLE rooms ADD INDEX IF NOT EXISTS idx_available (available);
...
ALTER TABLE activities ADD INDEX IF NOT EXISTS idx_available (available);
...
ALTER TABLE events ADD INDEX IF NOT EXISTS idx_available (available);
